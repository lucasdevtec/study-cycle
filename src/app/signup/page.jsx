...
import { Box, Button, Card, CardContent, Container, Stack, TextField, Typography, Alert, CircularProgress } from "@mui/material";
					...
					<CardContent sx={{ p: 4 }}>
						<Stack spacing={3}>
							...
							<form onSubmit={handleSignup}>
								<Stack spacing={2}>
									...
									<Button variant="contained" size="large" type="submit" disabled={loading} sx={{ position: "relative", mt: 2 }}>
										...
										<span style={{ visibility: loading ? "hidden" : "visible" }}>Criar Conta</span>
									</Button>
								</Stack>
							</form>
							...
							<Typography variant="body2" color="text.secondary" sx={{ mt: 2 }}>
								Já tem conta?{" "}
								<Button variant="text" size="small" href="/login" sx={{ textTransform: "none" }}>
									Faça login
								</Button>
							</Typography>
						</Stack>
